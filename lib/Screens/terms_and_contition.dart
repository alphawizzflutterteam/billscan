...
class TerAndCondition extends StatefulWidget {
  const TerAndCondition({Key? key}) : super(key: key);

  @override
  State<TerAndCondition> createState() => _TerAndConditionState();
}

class _TerAndConditionState extends State<TerAndCondition> {
...
appBar: PreferredSize(
    ...
    child: CustomAppbar(titlee: 'Terms & Conditions')),
        ...
        child: Padding(
          ...
          [
            ...
            getsettingModel==null?Container(
             ...
             Html(data: "${getsettingModel?.data.termsConditions.first}"),
